...
public static  java.net.NetworkInterface getByName(java.lang.String arg0) throws java.net.SocketException { throw new RuntimeException("Stub!"); }
public static  java.net.NetworkInterface getByIndex(int arg0) throws java.net.SocketException { throw new RuntimeException("Stub!"); }
public static  java.net.NetworkInterface getByInetAddress(java.net.InetAddress arg0) throws java.net.SocketException { throw new RuntimeException("Stub!"); }
