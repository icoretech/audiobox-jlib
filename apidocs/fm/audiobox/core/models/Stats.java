...
public  long getDataServedOverall() { throw new RuntimeException("Stub!"); }
public  long getDataServedThisMonth() { throw new RuntimeException("Stub!"); }
public  long getBoxDataStoredOverall() { throw new RuntimeException("Stub!"); }
public  long getCloudDataStoredOverall() { throw new RuntimeException("Stub!"); }
...
public  long getSkydriveDataStoredThisMonth() { throw new RuntimeException("Stub!"); }
public  long getSoundcloudDataStoredThisMonth() { throw new RuntimeException("Stub!"); }
}
